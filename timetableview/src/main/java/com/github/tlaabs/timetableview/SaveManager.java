    ...
    public static String saveSticker(HashMap<Integer, Sticker> stickers){
        ...
        for(int i = 0 ; i < orders.length; i++){
            ...
            for(Schedule schedule : schedules){
                ...
                obj3.addProperty("classTitle",schedule.jobTitle);
                obj3.addProperty("classPlace",schedule.jobSalary);
                obj3.addProperty("professorName",schedule.getJobId());
    ...
    public static HashMap<Integer,Sticker> loadSticker(String json){
        ...
        for(int i = 0 ; i < arr1.size(); i++){
            ...
            for(int k = 0 ; k < arr2.size(); k++){
                ...
                schedule.setJobTitle(obj3.get("classTitle").getAsString());
                schedule.setJobSalary(obj3.get("classPlace").getAsInt());
                schedule.setJobId(obj3.get("professorName").getAsString());
